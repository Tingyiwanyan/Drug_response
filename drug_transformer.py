...
class drug_transformer_():
    ...
    def model_construction_midi(self, if_mutation=None):
        ...
        X_global1, att_score_global1, Y_key1 = self.decoder_global_1(X_global, Y, if_sparse_max=True, if_select_feature_=True)
        ...
        Y_key1 = self.dense_6(Y_key1)
        Y_key2 = self.dense_6(Y_key2)
        Y_key3 = self.dense_6(Y_key3)
        Y_global1 = tf.math.multiply(att_score_global1, Y_key1)
